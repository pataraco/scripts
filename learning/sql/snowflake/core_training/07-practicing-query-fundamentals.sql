...
--         end of this exercise for for you to review if you get stuck building
--         the SQL yourself.
...
-- 7.2.1   Select 10 rows form the ORDERS table.

-- 7.2.2   Select all the DISTINCT values from o_orderstatus.
...
-- 7.3.7   Set your schema back to LEARNING.PUBLIC to prepare for the next
--         task:
