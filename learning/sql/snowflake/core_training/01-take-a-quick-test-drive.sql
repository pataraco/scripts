...
-- 1.1.4   Verify that you have LEARNING role selected.
...
-- 1.2.3   Name the database LEARNING.
...
-- 1.3.2   Click [Create] and create a table named LEARNING.
...
-- 1.4.4   Drop your warehouse, and then recreate your database (LEARNING)
--         using SQL:

DROP WAREHOUSE LEARNING;
...
ALTER USER LEARNING
    SET
    DEFAULT_ROLE=LEARNING
    DEFAULT_NAMESPACE=LEARNING.PUBLIC
    DEFAULT_WAREHOUSE=LEARNING;
