...
ALTER SESSION SET QUERY_TAG = 'LEARNING_Sizing';
...
ALTER WAREHOUSE LEARNING SUSPEND;
ALTER WAREHOUSE LEARNING SET WAREHOUSE_SIZE = Medium;
ALTER WAREHOUSE LEARNING RESUME;
...
ALTER WAREHOUSE LEARNING SUSPEND;
ALTER WAREHOUSE LEARNING SET WAREHOUSE_SIZE = Large;
ALTER WAREHOUSE LEARNING RESUME;
...
ALTER WAREHOUSE LEARNING SUSPEND;
ALTER WAREHOUSE LEARNING SET WAREHOUSE_SIZE = XLarge;
ALTER WAREHOUSE LEARNING RESUME;
...
WHERE  query_tag = 'LEARNING_Sizing' 
