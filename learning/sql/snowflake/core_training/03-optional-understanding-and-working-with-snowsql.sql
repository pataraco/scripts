...
--         Snowflake similar to the Web UI. The Web UI does not current support
--         the GET or PUT in SQL for putting data into stages or getting out of
--         stages. We will use SnowSQL here to learn how to upload data into
--         Snowflake internal stages and download data out of Snowflake internal
--         stages.
...
-- 3.2.5   Create a LEARNING table if you hadn’t already in LEARNING. You may
...
CREATE OR REPLACE TABLE LEARNING.PUBLIC.LEARNING (
  id NUMBER(38,0),
  name STRING(10),
  country VARCHAR(20),
  order_date DATE
...
INSERT INTO LEARNING VALUES(2, 'A','UK', '11/02/2005');
INSERT INTO LEARNING VALUES(4, 'C','SP', '11/02/2005');
INSERT INTO LEARNING VALUES(3, 'C','DE', '11/02/2005');
...
-- 3.2.8   Query the data in LEARNING and order it by ID:
...
snowsql -a [account] -u LEARNING -f script.sql
