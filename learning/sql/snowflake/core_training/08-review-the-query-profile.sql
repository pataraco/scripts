...
-- 8.1.5   Run an explain plan on the sample query with a LIMIT:
...
-- 8.4.0   Run an explain plan on the query without the limit
...
-- 8.5.0   Run the same query without the limit or the explain plan
